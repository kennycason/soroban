class Call < Formula
  ...
  url "http://search.maven.org/remotecontent?filepath=com/kennycason/soroban/1.0/soroban-1.0.jar"
  sha256 "38b71bd58d677fee3063bf3bfacfa1e3f90a842875d5fd02016f0c9adf8080fc"

  def install
    libexec.install "soroban-1.0.jar"
    bin.write_jar_script libexec/"soroban-1.0.jar", "soroban"
    puts "Finished installing Soroban 1.0"
  end
